...
public class SortByParameterTest {
    ...
    @Test
    public void findByYearOfIssueTest() throws CarException {
    ...
    @Test
    public void orderByConsumptionTest() throws CarException {
        TaxiPark expected = new TaxiPark();
    ...
    @Test
    public void findAllLorryTest() throws CarException {
        TaxiPark expected = new TaxiPark();
        expected.add(car2);
        expected.add(car3);
    ...
    @Test
    public void findAllPassangerCarTest() throws CarException {
        TaxiPark expected = new TaxiPark();
        expected.add(car);
        expected.add(car1);
        expected.add(car4);
