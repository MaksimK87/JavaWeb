...
public class RandomCreator {
    ...
    public List<Car> createRandomCars() {  // If car type > 0 and < 1 creates Passanger car, else creates Lorry
    ...
    private Car carPropertiesInit(Car car) {
